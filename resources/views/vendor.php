            ...
            <form class="vendor_register_form" method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control company_name" id="company_name"
                        placeholder="Enter your company name" name="company_name" data-parsley-required
                        data-parsley-required-message="Please insert your company name"
                        >
                </div>
                <div class="form-group">
                    <label for="exampleInputPassword1">Contact Person</label>
                    <input type="text" class="form-control contact_person" id="contact_person"
                        placeholder="Enter a contact person" data-parsley-required
                        data-parsley-required-message="Please enter your companies contact person"
                        name="contact_person">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control company_description" id="company_description" rows="3"
                    data-parsley-required data-parsley-required-message="Please enter a description about your company"
                    data-parsley-errors-container=".description_error_list" 
                    ></textarea>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control password" id="password" placeholder="Enter a  password"
                        data-parsley-required data-parsley-required-message="Please enter your password"
                        name="password">
                </div>
                <div class="form-group">
                    <label for="password">Retype Password</label>
                    <input type="text" class="form-control rpassword" id="rpassword"
